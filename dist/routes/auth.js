...
router.put('/change-password', auth_1.authenticateToken, [
    ...
    if (!isValidPassword) {
        return res.status(401).json((0, common_1.createErrorResponse)('Current password is incorrect'));
    }
    // Hash new password
...
router.post('/logout', auth_1.authenticateToken, (req, res) => {
    ...
    // The server can't invalidate JWT tokens without additional infrastructure
    res.json((0, common_1.createSuccessResponse)(null, 'Logout successful'));
});
