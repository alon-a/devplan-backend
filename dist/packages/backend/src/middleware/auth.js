...
exports.validateEmail = exports.validatePassword = exports.comparePassword = exports.hashPassword = exports.generateToken = exports.requireOwnership = exports.requireAdmin = exports.requireRole = exports.optionalAuth = exports.authenticateToken = void 0;
...
const requireAdmin = (req, res, next) => {
    ...
    const userRole = 'user'; // Default role for now
    if (userRole !== 'admin') {
        return next(new common_1.AuthorizationError('Admin access required'));
    }
    next();
};
